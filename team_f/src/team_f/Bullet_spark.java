...
public class Bullet_spark extends Bullet_Spark_State {

		Spark_Bullet_Move move;
	public Bullet_spark() {
		move= new Spark_Bullet_Move();
		index_x = 0;
		index_y = 0;
		start_x = 0;// 그림상의 좌표
		start_y = 0;
		...
		//move.Copydata();
		try {
			Bul = ImageIO.read(new File("team_f/src/Resource/Bullet-spark.png"));
