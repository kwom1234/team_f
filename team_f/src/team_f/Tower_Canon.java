...
public class Tower_Canon extends Tower_State {
	...
	int w; //
	int h;
	public ArrayList<Bullet_canon> bullet = new ArrayList<Bullet_canon>();
	public Tower_Canon() {
		...
		// count=0;
		try {
			tower = ImageIO.read(new File("team_f/src/Resource/Tower-cannon.png"));
	...
	public void SettingStartPoint(Bullet_canon b) {
		
			b.move.StartSetting(xx, yy);
			b.move.lunch();
	}
	public void addBullet() {
		Bullet_canon b = new Bullet_canon();
		SettingStartPoint(b);
		bullet.add(b);
